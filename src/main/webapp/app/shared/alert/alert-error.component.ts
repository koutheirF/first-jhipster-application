...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, translateService: TranslateService) {
    this.errorListener = eventManager.subscribe('firstJhipsterApplicationApp.error', (response: JhiEventWithContent<AlertError>) => {
          ...
          case 400: {
            ...
            if (errorHeader) {
              ...
              for (const fieldError of fieldErrors) {
                ...
                const fieldName = translateService.instant('firstJhipsterApplicationApp.' + fieldError.objectName + '.' + convertedField);
