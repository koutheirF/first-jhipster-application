...
@RestController
@RequestMapping("/api/first-jhipster-application-kafka")
public class FirstJhipsterApplicationKafkaResource {
    private final Logger log = LoggerFactory.getLogger(FirstJhipsterApplicationKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FirstJhipsterApplicationKafkaResource(KafkaProperties kafkaProperties) {
