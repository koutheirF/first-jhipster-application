package com.kouthair.jhipster.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("firstJhipsterApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("firstJhipsterApplication");
        ...
        config.getMapConfigs().put("com.kouthair.jhipster.domain.*", initializeDomainMapConfig(jHipsterProperties));
