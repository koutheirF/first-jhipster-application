...
import com.kouthair.jhipster.config.KafkaProperties;
...
class FirstJhipsterApplicationKafkaResourceIT {
    ...
    void setup() {
        ...
        FirstJhipsterApplicationKafkaResource kafkaResource = new FirstJhipsterApplicationKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/first-jhipster-application-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/first-jhipster-application-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
